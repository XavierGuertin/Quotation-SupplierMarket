<?php include('./assets/header.php'); 
    ...
    $sqlApproval= "SELECT * FROM heroku_8714cfa5818f328.requests WHERE groupAssigned = '$group' and status = 'approval'";
    $approvalResults = $conn->query($sqlApproval);
...
<body>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s" style="color:white;">Requests Sent</h1>
                <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
                    <ul class="nav nav-pills d-inline-flex justify-content-center border-bottom mb-5">
                        <li class="nav-item">
                            <a class="d-flex align-items-center text-start mx-3 ms-0 pb-3 active" data-bs-toggle="pill" href="#tab-1">
                                <h6 class="mt-n1 mb-0" style="color:white;">Waiting</h6>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="d-flex align-items-center text-start mx-3 pb-3" data-bs-toggle="pill" href="#tab-2">
                                <h6 class="mt-n1 mb-0" style="color:white;">Approval Required</h6>
                            </a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="tab-2" class="tab-pane fade show p-0">
                            <?php
                            if (mysqli_num_rows($approvalResults) == 0) {
                            ?>
                                <a style="color:white"> NOTHING TO SHOW </a>
                            <?php
                            }
